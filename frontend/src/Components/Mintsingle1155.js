...
function Mintsingle1155() {
  ...
  async function submitMint(page){
    if(name=="" || description=="" || link=="" || supply =="" || selectedFile == null)errorNotify("please fill all the data before minting")
    else{
      setMinting(true);
